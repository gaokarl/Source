...
*/
/******************************************************************************/
/** \file system_s6e1c3.h
 **
 ** Headerfile for FM0+ system parameters
 **
 ** History: 
 ** 2013-12-06  1.0  Edison Zhang  First version for FM0+ s6e1c3 series
 ** 2014-01-14  1.1  Edison Zhang  Configure PCLK0 and PCLK1 to the maximum 
 **                                frequency.
 ** 2014-08-26  1.2  EH            Added Low-speed CR Prescaler Control Register value
 **
 ******************************************************************************/

#ifndef _SYSTEM_S6E1C3_H_
#define _SYSTEM_S6E1C3_H_
 ...
 ** - 1: CLOCK_SETTING_CMSIS - Clock setting done in system_s6e1c3.h like in
 ...
 ** - CLOCK_SETTING_CMSIS - Clock setting done in system_s6e1c3.h like in
 **                         FM0+ template projects
 ******************************************************************************/ 
 ...
 **
 ** Bit#0 : HCRE 
 ** - 0 = Disable high-speed CR oscillation 
 ** - 1 = Enable high-speed CR oscillation  (default)
 ******************************************************************************/ 
 ...
 ******************************************************************************/    
#define PLL_CTL1_Val          0x00000002ul    // <<< Define PLL_CTL1 here
 ...
 ******************************************************************************/    
#define PLL_CTL2_Val          0x00000003ul    // <<< Define PLL_CTL2 here
 ...
 **        <i>(DEVICE DEPENDENT SETTING)</i>
 ******************************************************************************/ 
#define __PLLCLKINMIN (  8000000ul)
...
/******************************************************************************/
#if (CHECK_RSVD((SCM_CTL_Val),    ~0x000000FBul))
   #error "SCM_CTL: Invalid values of reserved bits!"
#endif

#if ((SCM_CTL_Val & 0xE0ul) == 0x00ul) && ((SCM_CTL_Val & 0x01ul) != 0x01ul) 
   #error "SCM_CTL: High-speed CR mode is selected but HCR is not enabled!"
#endif  
...
#if (CHECK_RSVD((APBC1_PSR_Val),  ~0x00000083ul))
